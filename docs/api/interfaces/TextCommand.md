...
[src/types/module.ts:46](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L46)
...
[src/types/module.ts:47](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L47)
...
• **onEvent**: [`Plugin`](Plugin.md) & { `execute`: (`event`: [ctx: Context, args: ["text", string[]]], `controller`: [`Controller`](Controller.md)) => `Awaitable`<`Result`<`void`, `void`\>\> ; `type`: [`Event`](../enums/PluginType.md#event)  }[]

#### Defined in

[src/types/module.ts:44](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L44)
...
[src/types/module.ts:45](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L45)
...
[src/types/module.ts:43](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L43)
