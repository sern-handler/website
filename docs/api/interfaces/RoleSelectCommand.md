...
[src/types/module.ts:106](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L106)
...
• **onEvent**: [`Plugin`](Plugin.md) & { `execute`: (`event`: [ctx: RoleSelectMenuInteraction<CacheType\>], `controller`: [`Controller`](Controller.md)) => `Awaitable`<`Result`<`void`, `void`\>\> ; `type`: [`Event`](../enums/PluginType.md#event)  }[]

#### Defined in

[src/types/module.ts:104](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L104)
...
[src/types/module.ts:105](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L105)
...
[src/types/module.ts:103](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L103)
