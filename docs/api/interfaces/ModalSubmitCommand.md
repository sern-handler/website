...
[src/types/module.ts:127](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L127)
...
• **onEvent**: [`Plugin`](Plugin.md) & { `execute`: (`event`: [ctx: ModalSubmitInteraction<CacheType\>], `controller`: [`Controller`](Controller.md)) => `Awaitable`<`Result`<`void`, `void`\>\> ; `type`: [`Event`](../enums/PluginType.md#event)  }[]

#### Defined in

[src/types/module.ts:125](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L125)
...
[src/types/module.ts:126](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L126)
...
[src/types/module.ts:124](https://github.com/sern-handler/handler/blob/eb2924c/src/types/module.ts#L124)
