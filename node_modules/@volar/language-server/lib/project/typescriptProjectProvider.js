...
exports.sortTSConfigs = exports.createTypeScriptProjectProviderFactory = void 0;
...
function createTypeScriptProjectProviderFactory(ts, tsLocalized) {
    return (context, servicePlugins, getLanguagePlugins) => {
        ...
        async function findMatchTSConfig(uri) {
            ...
            while (true) {
                ...
                for (const tsConfigName of rootTsConfigNames) {
                    ...
                    if ((await fs.stat?.((0, uri_1.fileNameToUri)(tsconfigPath)))?.type === language_service_1.FileType.File) {
                ...
                if (parsedCommandLine.projectReferences?.length) {
                    ...
                    for (const projectReference of parsedCommandLine.projectReferences) {
                        ...
                        if ((await fs.stat?.((0, uri_1.fileNameToUri)(tsConfigPath)))?.type === language_service_1.FileType.File) {
                            ...
                            if ((await fs.stat?.((0, uri_1.fileNameToUri)(newTsConfigPath)))?.type === language_service_1.FileType.File) {
                                tsConfigPath = newTsConfigPath;
                            }
                            else if ((await fs.stat?.((0, uri_1.fileNameToUri)(newJsConfigPath)))?.type === language_service_1.FileType.File) {
        ...
        function getOrCreateConfiguredProject(tsconfig) {
            ...
            if (!projectPromise) {
                const workspaceFolder = (0, simpleProjectProvider_1.getWorkspaceFolder)((0, uri_1.fileNameToUri)(tsconfig), context.workspaceFolders);
                const serviceEnv = (0, simpleProjectProvider_1.createServiceEnvironment)(context, workspaceFolder);
                projectPromise = (0, typescriptProject_1.createTypeScriptServerProject)(ts, tsLocalized, tsconfig, context, serviceEnv, servicePlugins, getLanguagePlugins);
        ...
        async function getOrCreateInferredProject(uri, workspaceFolder) {
            if (!inferredProjects.uriHas(workspaceFolder)) {
                inferredProjects.uriSet(workspaceFolder, (async () => {
                    ...
                    const serviceEnv = (0, simpleProjectProvider_1.createServiceEnvironment)(context, workspaceFolder);
                    return (0, typescriptProject_1.createTypeScriptServerProject)(ts, tsLocalized, inferOptions, context, serviceEnv, servicePlugins, getLanguagePlugins);
                })());
            }
...
exports.createTypeScriptProjectProviderFactory = createTypeScriptProjectProviderFactory;
