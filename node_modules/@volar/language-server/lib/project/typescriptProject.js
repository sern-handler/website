...
async function createTypeScriptServerProject(ts, tsLocalized, tsconfig, context, serviceEnv, servicePlugins, getLanguagePlugins) {
    ...
    const host = {
        getCurrentDirectory: () => (0, uri_1.uriToFileName)(serviceEnv.workspaceFolder),
        getProjectVersion: () => projectVersion.toString(),
        getScriptFileNames: () => rootFiles,
        getScriptSnapshot: fileName => {
            askedFiles.pathSet(fileName, true);
            const doc = context.documents.get((0, uri_1.fileNameToUri)(fileName));
            if (doc) {
